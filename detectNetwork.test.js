...
describe('Maestro', function() {
  ...
  it('has a prefix of 5018 and a length of 19', function() {
    detectNetwork('5018123456780912345').should.equal('Maestro');
  });
  ...
  it('has a prefix of 5020 and a length of 19', function() {
    detectNetwork('5020123456780912345').should.equal('Maestro');
  });
  ...
  it('has a prefix of 5038 and a length of 19', function() {
    detectNetwork('5038123456780912345').should.equal('Maestro');
  });
  ...
  it('has a prefix of 6304 and a length of 19', function() {
    detectNetwork('6304123456780912345').should.equal('Maestro');
  });
});
...
//     (function(prefix) {
//       it('has a prefix ' + prefix + ' and a length of 16', function() {        detectNetwork(prefix + '1234567890').should.equal('China UnionPay');
//       });
//     }(prefix));
//   }
...
//   for (var prefix = 622126; prefix <= 622925; prefix++) {
//     (function(prefix) {
//       it('has a prefix ' + prefix + ' and a length of 17', function() {        detectNetwork(prefix + '12345678901').should.equal('China UnionPay');
//       });
//     }(prefix));
//   }
...
//   for (var prefix = 622126; prefix <= 622925; prefix++) {
//     (function(prefix) {
//       it('has a prefix ' + prefix + ' and a length of 18', function() {        detectNetwork(prefix + '123456789012').should.equal('China UnionPay');
//       });
//     }(prefix));
//   }
...
//   for (var prefix = 622126; prefix <= 622925; prefix++) {
//     (function(prefix) {
//       it('has a prefix ' + prefix + ' and a length of 19', function() {        detectNetwork(prefix + '1234567890123').should.equal('China UnionPay');
//       });
//     }(prefix));
//   }
